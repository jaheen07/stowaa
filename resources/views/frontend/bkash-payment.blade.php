...
@section('content')
<div class="col col-lg-2 mx-auto mt-5 mb-5">
    <!-- <p class="card-text amount">{{ $datas }}</p>
    <p class="card-text invoice">27</p> -->
    <button class="btn btn-success" id="bKash_button" onclick="BkashPayment()">Pay with bKash</button>
</div>
